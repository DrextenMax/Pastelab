...
function Toggle({ checked, onChange, disabled }: ToggleProps) {
  return (
    <motion.button
      ...
      style={{
        background: checked ? "rgba(109,40,217,0.85)" : "rgba(255,255,255,0.1)",
        border: `1px solid ${checked ? "rgba(139,92,246,0.5)" : "rgba(255,255,255,0.12)"}`,
            ...
            >
              ...
              <Section title="About">
                <div className="py-3 space-y-2">
                  ...
                  <p className="text-center text-[11px] pt-1" style={{ color: "rgba(255,255,255,0.18)" }}>
